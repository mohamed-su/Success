-- Script SQL pour ajouter les champs manquants dans protocol_evaluations

-- Ajouter les champs manquants
ALTER TABLE protocol_evaluations 
ADD COLUMN IF NOT EXISTS protocol_reference VARCHAR(255),
...
ADD COLUMN IF NOT EXISTS member_koueta BOOLEAN DEFAULT false,
ADD COLUMN IF NOT EXISTS member_nanga BOOLEAN DEFAULT false,
ADD COLUMN IF NOT EXISTS member_drabo BOOLEAN DEFAULT false,
ADD COLUMN IF NOT EXISTS member_toe BOOLEAN DEFAULT false,
ADD COLUMN IF NOT EXISTS member_ouedraogo1 BOOLEAN DEFAULT false,
ADD COLUMN IF NOT EXISTS member_ouedraogo2 BOOLEAN DEFAULT false;
