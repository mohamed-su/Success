...
public class NewEvaluationFormController {
    ...
    @ResponseBody
    public ResponseEntity<String> getNewEvaluationForm(@PathVariable Long protocolId) {
        try {
            ...
            if (!protocolInfo.isEmpty()) {
                Map<String, Object> protocol = protocolInfo.get(0);
                title = (String) protocol.get("title");
            ...
            String frenchDate = java.time.LocalDate.now().format(java.time.format.DateTimeFormatter.ofPattern("dd/MM/yyyy"));
            
            String html = generateDeliberationFormHTML(protocolId, deliberationNumber, currentDate, frenchDate, title, investigator, institution);
    ...
    private String generateDeliberationFormHTML(Long protocolId, String deliberationNumber, String currentDate, String frenchDate, String title, String investigator, String institution) {
        return """
<!DOCTYPE html>
<html lang="fr">
<head>
...
<body>
    <div class="form-container">
        ...
        <form id="deliberationForm">
            ...
            <div class="field">
                ...
                <input type="text" name="principalInvestigator" value="%s" required>
            </div>
    ...
    <script>
        document.getElementById('deliberationForm').addEventListener('submit', function(e) {
            ...
            fetch('http://localhost:8081/api/evaluation/submit', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    protocolId: %d,
                    memberId: 4, // ID du membre connecté (à adapter selon votre système d'auth)
                    ...data
                })
            })
        ...
        """.formatted(
            ...
            institution != null ? institution : "Burkina Faso",
            currentDate,
            frenchDate,
            protocolId
        );
